...
interface AnimatedGradientBackgroundProps {
   ...
   * @default ["#0A0A0A", "#2979FF", "#FF80AB", "#FF6D00", "#FFFFFF"]
   */
...
const AnimatedGradientBackground: React.FC<AnimatedGradientBackgroundProps> = ({
  startingGap = 560,
  Breathing = true,
  gradientColors = ["#0A0A0A", "#2979FF", "#FF80AB", "#FFF", "#FFF"],
  gradientStops = [7, 9, 11, 13, 100],
  animationSpeed = 0.02,
  breathingRange = 5,
  containerStyle = {},
  topOffset = 0,
  ...
  return (
    <motion.div
      ...
      className={`absolute inset-0 overflow-x-hidden overflow-y-visible ${containerClassName}`}
      style={{ zIndex: -1 }}
    >
      <div
        ref={containerRef}
        className="absolute top-0 left-1/2 w-[128vw] -translate-x-1/2 pointer-events-none"
        style={{
          height: "120vh",
          top: "-10vh",
          ...containerStyle,
